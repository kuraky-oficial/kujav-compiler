        ...
        match expr {
            ...
            Expr::Binary(l, op, r) => {
                if op == "+" && (self.is_string_expr(&l) || self.is_string_expr(&r)) {
                    ...
                    let sig_l_str = if l_str { "(Ljava/lang/String;)Ljava/lang/StringBuilder;" } else { "(I)Ljava/lang/StringBuilder;" };
                    let app_n = self.cp.add_utf8("append");
                    let sig_l = self.cp.add_utf8(sig_l_str);
                    let nt_l = self.cp.add_name_and_type(app_n, sig_l);
                    ...
                    let sig_r_str = if r_str { "(Ljava/lang/String;)Ljava/lang/StringBuilder;" } else { "(I)Ljava/lang/StringBuilder;" };
                    let sig_r = self.cp.add_utf8(sig_r_str);
                    let nt_r = self.cp.add_name_and_type(app_n, sig_r);
            ...
            Expr::Input => {
                ...
                let nt_in = self.cp.add_name_and_type(in_u, in_s);
